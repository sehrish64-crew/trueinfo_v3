export function getOrganizationSchema() {
  return {
    ...
    '@type': 'Organization',
    name: 'TrueInfoProvider',
    url: 'https://trueinfoprovider.com',
    logo: 'https://trueinfoprovider.com/favicon.ico',
...
export function getLocalBusinessSchema() {
  return {
    ...
    name: 'TrueInfoProvider',
    description: "Trust data, not words. Check any car's history in seconds",
    image: 'https://trueinfoprovider.com/favicon.ico',
    url: 'https://trueinfoprovider.com',
    priceRange: '$$',
    areaServed: {
      '@type': 'Country',
...
export function getArticleSchema(article: {
  ...
  return {
    ...
    image: article.image || 'https://trueinfoprovider.com/favicon.ico',
    datePublished: article.datePublished || new Date().toISOString(),
    author: {
      '@type': 'Organization',
      name: article.author || 'TrueInfoProvider',
    },
  };
}
