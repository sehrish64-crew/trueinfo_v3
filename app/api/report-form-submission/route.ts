...
const ADMIN_EMAIL = process.env.ADMIN_PAYMENT_EMAIL || 'trueinfoprovider.com@gmail.com'
    ...
    const customerEmailHtml = `
      <div style="font-family: sans-serif; max-width: 600px; padding: 20px; border: 1px solid #eee; border-radius: 10px;">
        ...
        <div style="background: #f0f9ff; padding: 15px; border-radius: 8px; border-left: 4px solid #3b82f6; margin: 20px 0;">
          ...
          <p style="margin: 8px 0;"><strong>Customer Name:</strong> ${customerName || 'Not provided'}</p>
        ...
        <p style="margin-top: 20px; color: #666; font-size: 14px;">Thank you for using TrueInfoProvider!</p>
        <p>Best Regards,<br/><strong>TrueInfoProvider Team</strong></p>
      </div>
    `
    ...
    try {
      await pool.query(
        `INSERT INTO report_submissions (
          ...
          vehicle_identifier, vehicle_type, package_id,
          amount, currency, submitted_at
        ) VALUES (?, ?, ?, ?, ?, ?, ?, ?, NOW())`,
