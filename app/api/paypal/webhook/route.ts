        ...
        if (status === 'completed') {
          try {
            ...
            if (orderDetails && orderDetails.length > 0) {
              ...
              const adminEmail = process.env.ADMIN_PAYMENT_EMAIL || 'trueinfoprovider.com@gmail.com'
              ...
              if (customerEmail) {
                const customerEmailContent = `
                  <div style="font-family: sans-serif; max-width: 600px; padding: 20px; border: 1px solid #eee; border-radius: 10px;">
                    ...
                    <p style="margin-top: 20px; color: #666; font-size: 14px;">Thank you for choosing TrueInfoProvider! If you have any questions, please contact us.</p>
