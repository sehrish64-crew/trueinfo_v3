...
### 1️⃣ **Step 1: User Fills Get Report Form**
   ...
   - **What Happens:** 
     ...
     - ✉️ **Email sent to:** `trueinfoprovider.com@gmail.com`
...
#### 📧 **Email #1 - Customer Order Confirmation**
   - **Sent to:** `trueinfoprovider.com@gmail.com` (customer's email)
   - **From:** `trueinfoprovider.com@gmail.com`
   - **Content:**
     - Order ID
     - Amount paid
     - Package details
...
#### 📧 **Email #2 - Admin Payment Notification**
   - **Sent to:** `trueinfoprovider.com@gmail.com` (admin)
   - **From:** `trueinfoprovider.com@gmail.com`
   - **Content:**
     - Customer email
     - Order details
...
| **SMTP Port** | `587` |
| **SMTP User** | `trueinfoprovider.com@gmail.com` |
| **Email From** | `TrueInfoProvider <trueinfoprovider.com@gmail.com>` |
| **Admin Email** | `trueinfoprovider.com@gmail.com` |
...
5. ✅ Check if you received the form submission email at `trueinfoprovider.com@gmail.com`
...
```
To: user@example.com
Subject: Payment Confirmed - TrueInfoProvider Order #ORD-123456
